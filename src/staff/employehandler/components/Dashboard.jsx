      ...
      <main className="flex-1 md:ml-[280px] md:mt-[64px] p-[16px] md:p-[32px] max-w-[1280px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-[32px] gap-[16px]">
          ...
          <div className="flex gap-[12px]">
            <button className="px-[16px] py-[8px] bg-[#f2f4f6] text-[#191c1e] text-[12px] font-semibold tracking-[0.05em] rounded-[8px] border border-[#bfc7d2] hover:bg-[#e0e3e5] transition-colors flex items-center gap-2">
              <span className="material-symbols-outlined text-[18px]">download</span>
              Export Report
            </button>
            <button className="px-[16px] py-[8px] bg-[#004870] text-white text-[12px] font-semibold tracking-[0.05em] rounded-[8px] hover:bg-[#006194] active:scale-95 transition-all flex items-center gap-2 shadow-sm">
